...
- (void)initHeadView{
    ...
    UILabel *cardLabel = [[UILabel alloc] initWithFrame:CGRectMake(_leftBottomBtn.bounds.size.width / 2.0, _leftBottomBtn.bounds.size.height * 0.1, _leftBottomBtn.bounds.size.width / 2.0,  _leftBottomBtn.bounds.size.height)];
    cardLabel.text = @"收藏名片";
...
//    [_headView addSubview:titleLabel];
    ...
    UIButton *messageButton = [[UIButton alloc] initWithFrame:CGRectMake(_headView.bounds.size.width * (1 - 0.1),  (nameLabel.frame.origin.y + nameLabel.frame.size.height), _headView.bounds.size.width / 5.0, 27)];
