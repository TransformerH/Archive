...
/*
 ...
 {
 if (!_headScrollView) {
 _headScrollView = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, CGRectGetWidth([UIScreen mainScreen].bounds), 120)];
 _headScrollView.backgroundColor = [UIColor purpleColor];
 _headScrollView.font = [UIFont systemFontOfSize:30];
 _headScrollView.textAlignment = NSTextAlignmentCenter;
 _headScrollView.text = @"这是模拟头部视图";
 }
