...
+ (NSArray*)messageListFromPlist{
    ...
    NSString *plistPath1= [paths objectAtIndex:0];
    NSString *fileName = [plistPath1 stringByAppendingPathComponent:@"messageList.plist"];
    NSMutableArray *messageArray = [NSMutableArray arrayWithContentsOfFile:fileName];
    
    return [[NSArray alloc] initWithArray:messageArray];
}
...
+ (NSArray*)commentListFromPlist{
    ...
    NSString *plistPath1= [paths objectAtIndex:0];
    NSString *fileName = [plistPath1 stringByAppendingPathComponent:@"commentList.plist"];
    NSMutableDictionary *commentDic = [NSMutableDictionary dictionaryWithContentsOfFile:fileName];
    NSArray *commentList = [[commentDic valueForKey:@"response"]valueForKey:@"results"];
